      ...
      <div className="mt-8 ">
        <div className="flex md:justify-center justify-evenly  gap-20 md:gap-24 text-xs md:text-lg">
          <div className="flex gap-1">
            ...
            <input
              className="border-2 border-slate-900 md:w-80 ml-2 md:ml-0 px-1  md:py-1 rounded-sm "
              type="text"
            ...
            {/* search button */}
            <button
              className="bg-green-400 px-4 md:py-1 rounded-sm  md:ml-2 "
              onClick={() => {
                setFilteredRes(
          ...
          <div className="mr-2 md:mr-20">
            <button
              className="bg-yellow-500 px-5 py-1 rounded-sm align-self-center"
              onClick={() => {
                setFilteredRes(
                  listOfRes.filter(
