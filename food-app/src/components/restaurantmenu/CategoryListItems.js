    ...
    <div>
      {listItems.map((item) => (
        <div
          ...
          className="border-b-2 border-slate-300 py-4 mx-3 flex justify-between align-items-center   gap-2 font-sans"
        >
          ...
          <div className=" w-4/12 md:w-3/12 relative">
            <img
              ...
              alt="item-pic"
              className="rounded-md  w-40  h-28   mt-3 object-cover"
            />
